...
namespace ServiceRest_093_Musafak
{
    ...
    public interface ITI_UMY
    {
        ...
        //Delete
        [OperationContract]
        [WebInvoke(Method = "POST",  RequestFormat = WebMessageFormat.Json, ResponseFormat = WebMessageFormat.Json, UriTemplate = "Mahasiswa/delete")]
        string DeleteData(Mahasiswa mhs);


        //Update
        [OperationContract]
        [WebInvoke(Method = "POST", RequestFormat = WebMessageFormat.Json, ResponseFormat = WebMessageFormat.Json, UriTemplate = "update")]
        string Update(Mahasiswa mhs);


    }

    // Use a data contract as illustrated in the sample below to add composite types to service operations.
    // You can add XSD files into the project. After building the project, you can directly use the data types defined there, with the namespace "ServiceRest_093_Musafak.ContractType".
    [DataContract]
